    ...
    <header className="max-w-screen-xl mx-auto p-4 flex justify-between items-center font-bold">
      ...
      <div className=" flex items-center">
        ...
        {account ? (
          ...
          <button
            className="flex items-center p-2 bg-gray-800 rounded-full ml-8"
...
//web3 정보를 가져올려면  npm i web3
//함수 내부에서 선언된 변수는 함수의 호출이 종료되면 메모리에서 제거됩니다 response변수가 왜 2개인지 같은 이름으로 중복되면 어칸,ㄴ지
